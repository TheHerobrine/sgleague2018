	...
	if (isset($_GET["gpage"]))
	{
		...
		while($data = $temp->fetch())
		{
			...
			while($data_p = $temp_p->fetch())
			{
				...
				echo '<td style="width:20px;text-align:center;"><a href="#"><i class="fa fa-square-o" aria-hidden="true"></i></a></td>
				<td>'.htmlspecialchars($data_p["PU_DISCORD"]).'</td>
