...
Si vous avez des problèmes de connexion, n'hésitez pas à passer sur discord ! <https://discord.gg/sgnw>\n\nL'équipe de la Student Gaming League 2018";
			...
			else
			{
				...
				//TODO_QUERY: doit fonctionner aussi avec le mail
				$query = "SELECT SU_MAIL, SU_LOGIN FROM T_SGL_USER WHERE LOWER(SU_MAIL)=LOWER(:login) AND SU_ACTIVATION IS NULL";
...
Si vous avez des problèmes de connexion, n'hésitez pas à passer sur discord ! <https://discord.gg/sgnw>\n\nL'équipe de la Student Gaming League 2018";
						...
						//TODO_QUERY: doit fonctionner aussi avec le mail
						$query = "UPDATE T_SGL_USER SET SU_RESETPASS=:resetsalt WHERE LOWER(SU_MAIL)=LOWER(:login) AND SU_ACTIVATION IS NULL";
					...
					{
						$error_recover = "<div style=\"text-align: center;\" class=\"error\"><i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i>Aucun utilisateur trouvé... Vous êtes sûr que vous êtes déjà inscrit ?</div>";
					}
				}
			}
		}
		...
		<div class="form">
			<form action="index.php?page=connect&recover=1" method="post">
				<table class="form_table">
					<tr><td><h3>Login / Mail :</h3></td><td><input name="login" type="mail" /><br />
					<div class="smallquote">Pour regénérer un mot passe, il me faut votre login ou votre mail.</div></td></tr>
				</table>
				<br /><br />
