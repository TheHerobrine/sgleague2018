...
CREATE TABLE `T_SCHOOL` (
  ...
  `S_WEBSITE` VARCHAR(1024) NOT NULL,
...
CREATE TABLE `T_SGL_USER` (
  ...
  `SU_PASS` VARCHAR(512) NOT NULL,
  `SU_SALT` VARCHAR(512) NOT NULL,
  ...
  `SU_BIRTH_DATE` DATE NOT NULL,
  `SU_REGISTER_DATE` DATETIME NOT NULL,
  `SU_PSEUDO` VARCHAR(128) NOT NULL,
  `SU_FIRST_NAME` VARCHAR(128) NOT NULL,
  `SU_LAST_NAME` VARCHAR(128) NOT NULL,
  `SU_KNOWLEDGE_ORIGIN` INTEGER(4) NOT NULL,
  PRIMARY KEY (`SU_UID`),
  UNIQUE KEY (`SU_LOGIN`),
  UNIQUE KEY (`SU_MAIL`)
)ENGINE=innodb;
...
CREATE TABLE `T_SGL_TEAM` (
  ...
  `ST_ID_G` INTEGER NULL DEFAULT NULL,
...
-- INSERT INTO `T_SGL_USER` (`SU_UID`,`SU_ID_CARD_F`,`SU_ID_S`,`SU_LOGIN`,`SU_PASS`,`SU_SALT`,`SU_RESETPASS`,`SU_MAIL`,`SU_ACTIVMAIL`,`SU_ACTIVATION`,`SU_TYPE`,`SU_GENDER`,`SU_BIRTH_DATE`,`SU_REGISTER_DATE`,`SU_PSEUDO`,`SU_FIRST_NAME`,`SU_LAST_NAME`) VALUES
-- ('','','','','','','','','','','','','','','','','');
...
-- ('','','','','','','','','');
-- INSERT INTO `T_GAME` (`G_UID`,`G_ID_LOGO_F`,`G_ID_P`,`G_NAME`,`G_DESCRIPTION`,`G_RANK_DESCRIPTION`) VALUES
-- ('','','','','','');
...
-- ('','','','');
-- INSERT INTO `T_PLATFORM` (`P_UID`,`P_ID_LOGO_F`,`P_NAME`,`P_PSEUDO_NAME`,`P_COMPANY`,`P_WEBSITE`) VALUES
-- ('','','','','','');
